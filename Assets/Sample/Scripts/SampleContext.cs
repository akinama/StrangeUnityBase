...
namespace vt.sampleproject
{
	...
	{
		public SampleContext (MonoBehaviour view) : base(view)
		{
		}
		...
		protected override void mapBindings()
		{
			...
			injectionBinder.Bind<ISampleModel>().To<SampleModel>().ToSingleton();
			injectionBinder.Bind<ISampleService>().To<SampleServiceStub>().ToSingleton();
			...
			commandBinder.Bind(SampleEvent.REQUEST_PLAYER_MOVE).To<SampleMoveCommand>();
